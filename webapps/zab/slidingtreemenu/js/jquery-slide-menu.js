...
//          element.html('<img class=\"navmainmenuimg\" src=\"images/icons/menu.png\">');
          ...
          if (element.data('expand')) {
              element.parent().animate({ left: '0px' }, {
                  duration: speed,
                  start: function () {
                  //    element.find('.fa').removeClass('fa-lg');
                  }
              });
		  var $li = element.parent().find('li')
		  $li.css("width","350px")
          } else {
		  var $li = element.parent().find('li')
		  $li.css("width","300px")
              element.parent().animate({ left: '-350px' }, {
                  duration: speed,
                  start: function () {
                    //  element.find('.fa').addClass('fa-lg');
                  }
              });
